...
async function createAccount(createdUser: string){
    const res = await fetch('https://griffinblogapi.azurewebsites.net/AddUser',{
        method:"POST",
        headers:{
...
async function GetLoggedInUserData(username: string){
    let res= await fetch(`Https://griffinblogapi.azurewebsites.net/User/userbyusername/${username}`)
    let data = await res.json();
    userData = data;
...
async function GetPublishedBlogItems(){
    let res = await fetch('Https://griffinblogapi.azurewebsites.net/blog/GetPublishedItems');
    let data = await res.json();
    return data;
}
...
async function addBlogItem(blogItem: string){
    const res = await fetch('Https://griffinblogapi.azurewebsites.net/blog/addblogitem',{
        method:"POST",
        headers:{
            'Content-Type': "application/json"
        },
...
async function getBlogItemsByUserId(userId: number){
    const res = await fetch(`Https://griffinblogapi.azurewebsites.net/blog/GetItemsByUserId/${userId}`);
    let data = await res.json();
    return data;
}

async function updateBlogItem(blogItem: string){
    const res = await fetch('Https://griffinblogapi.azurewebsites.net/blog/UpdateBlogItem',{
        method:"POST",
        headers:{
            'Content-Type': "application/json"
        },
